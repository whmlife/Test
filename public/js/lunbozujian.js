...
Slider.prototype.nextSlider=function(){
	...
	this.changeNav();
	this.changeSlider(1);
	console.log(this.curIndex + "big")
}
//点击原点改变图片
Slider.prototype.aaa=function(){
	var oLi = this.oDiv.querySelectorAll(".bnav li");
	var that = this;
	console.dir(that);
...
Slider.prototype.changeNav=function(){
	this.oDiv.querySelector(".bnav li.active").classList.remove("active");
	this.oDiv.querySelectorAll(".bnav li")[this.curIndex].classList.add("active");
}
